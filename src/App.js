...
const users = {
  1: {
    id: 1,    name: 'Jane Jones',    userName: 'coder',
  },
  2: {
    id: 2,    name: 'Matthew Johnson',    userName: 'mpage',
  },
  3: {
    id: 3,    name: 'Autumn Green',    userName: 'user123',
  },
  4: {
    id: 3,    name: 'John Doe',    userName: 'user123',
  },
  5: {
    id: 5,    name: 'Lauren Carlson',    userName: 'user123',
  },
  6: {
    id: 6,    name: 'Nicholas Lain',    userName: 'user123',
  },
};
  ...
  render() {
    return (
      <div className="App">
        ...
        <SummaryComponent usersByMovie={this.usersByMovie} movies={movies} users={users}/>
      </div>
    );
  }
}
